...
public class BebidaTest {
	...
	public void validarNombre() {
		...
		/*
		 * if (violations.size() > 0) { for (ConstraintViolation<Bebida> violation :
		 * violations) { System.out.println(violation.getMessage()); } con iterador es
		 * mas rapido que el for de arriba
		 */
		...
		while (it.hasNext()) {
			...
			/*
			 * System.out.println("Parametro: " + violation.getPropertyPath() +
			 * violation.getMessage() + ". Va con valor " + violation.getInvalidValue());
			 */
		}
